...
namespace BitcoinSharp.Tests.Unit
{
    ...
    public class ChainSplitTests
    {
        ...
        public void TestForking1()
        {
            ...
            _defaultWallet.Reorganized += (sender, e) => reorgHappened = true;
            ...
            Assert.AreEqual("100.00", Utils.BitcoinValueToFriendlyString(_defaultWallet.GetBalance()));
            ...
            Assert.AreEqual("200.00", Utils.BitcoinValueToFriendlyString(_defaultWallet.GetBalance()));
        }
