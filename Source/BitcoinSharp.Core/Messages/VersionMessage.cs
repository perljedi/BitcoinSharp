...
namespace BitcoinSharp.Core.Messages
{
    ...
    public class VersionMessage : AbstractMessage
    {
        ...
        public static  String BITCOINJ_VERSION = "0.11";
        
        /** The value that is prepended to the subVer field of this application. */
        public static  String LIBRARY_SUBVER = "/BitCoinJ:" + BITCOINJ_VERSION + "/";
        ...
        public override void BitcoinSerializeToStream(Stream outputStream)
        {
            ...
            // connections.
            Utils.Uint64ToByteStreamLe(0, outputStream);
            Utils.Uint64ToByteStreamLe(0, outputStream);
            //Yes. we need to call this twice.
        ...
        public override string ToString()
        {
            ...
            stringBuilder.Append("my addr:        ").Append((object) MyAddress).Append("\n");
            stringBuilder.Append("their addr:     ").Append((object) TheirAddress).Append("\n");
